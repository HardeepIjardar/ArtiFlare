  ...
  <div className="max-w-3xl mx-auto px-4 py-12">
    ...
    <div className="bg-white shadow rounded-lg p-6 mb-6">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center p-4 border border-gray-200 rounded-lg">
          <div>
            <span className="text-dark font-medium">Orders under ₹500</span>
        ...
        <div className="flex justify-between items-center p-4 border border-gray-200 rounded-lg bg-green-50">
          <div>
            <span className="text-dark font-medium">Orders above ₹500</span>
            <span className="text-dark-500 text-sm block">Standard delivery (3-5 business days)</span>
          </div>
          <span className="text-dark font-bold">₹30</span>
        </div>
      </div>
    </div>
    ...
    <div className="bg-blue-50 p-4 rounded-lg mb-6">
      ...
      <ul className="list-disc list-inside text-dark-600 space-y-1">
        <li>Delivery charges are calculated based on your order subtotal</li>
        <li>Orders under ₹500: ₹50 delivery charge</li>
        <li>Orders above ₹500: ₹30 delivery charge</li>
